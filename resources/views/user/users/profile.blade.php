    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <ul class="breadcrumbs">
                ...
                <li><a href="" class="active text-primary">Profil Page</a></li>
            </ul>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputTitle" type="text" name="name" placeholder="Entrez nom"
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputEmail" disabled type="email" name="email" placeholder="Entrez email"
                        ...
                        <div class="form-group">
                            ...
                            <select name="role" class="form-control">
                                ...
                                <option value="user" {{ $profile->role == 'user' ? 'selected' : '' }}>Utilisateur
                                </option>
                            </select>
                            @error('role')
                                <span class="text-danger">{{ $message }}</span>
