...
@endsection
@section('title','FauconShop || DETAIL DU PRODUIT')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Détails du magasin</a></li>
							</ul>
						</div>
					</div>
				</div>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	Vous devez <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Se connecter</a> OU <a style="color:blue" href="{{route('register.form')}}">S'inscrire</a>
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(En général)</span></h4>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec">{{$data->discount}} % de réduction</span>
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                ...
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Ajouter à comparer</span></a>
                                            </div>
