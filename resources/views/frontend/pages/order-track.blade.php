...
<section class="tracking_box_area section_gap py-5">
    <div class="container">
        <div class="tracking_box_inner">
            <p>Pour suivre votre commande, veuillez entrer votre numéro de commande dans la case ci-dessous et appuyez sur le bouton "Suivre". Cela vous a été donné sur votre reçu et dans l'email de confirmation que vous auriez dû recevoir.</p>
